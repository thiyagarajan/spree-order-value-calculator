...
[![Gem Version](https://badge.fury.io/rb/spree_order_value_calculator.png)](http://badge.fury.io/rb/spree_order_value_calculator)
...
Add to your `Gemfile`:
```ruby
gem 'spree_order_value_calculator', '~> 2.1.0'
```
